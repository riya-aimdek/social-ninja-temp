...
export default function CreatePage() {
  ...
  return (
    <div className="space-y-5 animate-fade-in pb-8 pt-4">
      {/* ============ Header card ============ */}
      <div className="bg-card rounded-xl shadow-card border border-border px-4 py-3 flex items-center gap-3">
        <div className="w-11 h-11 rounded-xl gradient-coral flex items-center justify-center shadow-coral shrink-0">
          <Sparkles className="w-5 h-5 text-primary-foreground" />
        </div>
        <div className="flex-1 min-w-0">
          <h1 className="text-base font-semibold leading-tight">Manual Compose</h1>
          <p className="text-xs text-muted-foreground mt-0.5 truncate">
            Write, design and schedule your post step by step.
          </p>
        </div>
