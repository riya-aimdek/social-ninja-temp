    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="w-[520px] bg-card border border-border rounded-2xl p-12">
        <div className="flex flex-col items-center mb-6">
          ...
          <span className="mt-2 text-[11px] text-organization bg-organization/15 border border-organization rounded-full px-3 py-1">Direct Path</span>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input className="input-dark pr-10" type={showPassword ? 'text' : 'password'} placeholder="Create a password" />
        ...
        {step === 2 && (
          <div className="space-y-4">
            ...
            <div><label className="text-sm text-text-secondary mb-1.5 block">Industry</label>
              <select className="input-dark"><option value="">Select industry</option><option>Retail</option><option>Technology</option><option>Healthcare</option><option>Food & Beverage</option></select>
            </div>
            ...
            <div>
              <label className="text-sm text-text-secondary mb-1.5 block">Logo (optional)</label>
              <div className="w-20 h-20 border-2 border-dashed border-border rounded-xl flex items-center justify-center hover:border-border-hover cursor-pointer">
