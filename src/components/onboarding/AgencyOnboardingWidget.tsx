...
const INITIAL_STEPS: Step[] = [
  { id: "brand",   name: "Set up your agency",     description: "Add your agency name and logo",    completed: false, route: "/agency/onboarding"  },
  { id: "client",  name: "Add a client",            description: "Create your first client account", completed: false, route: "/agency/clients"     },
  { id: "connect", name: "Connect social accounts", description: "Link client platforms",             completed: false, route: "/agency/social-accounts" },
  { id: "team",    name: "Add team members",        description: "Invite your agency team",           completed: false, route: "/agency/team"        },
];

export default function AgencyOnboardingWidget() {
    ...
    <>
          ...
          {allDone ? (
            <div className="p-6 text-center">
              ...
              <button
                ...
                style={{ fontSize: 12, fontWeight: 500, color: "#FD5C63" }}
                  ...
                  >
                    ...
                    >
                      {step.completed ? (
                        ...
                        <div style={{ width: 20, height: 20, borderRadius: "50%", border: "1.5px solid #D1D5DB" }} />
                      )}
                    </button>
      ...
      <button
        ...
        style={{
          ...
          background: "#fff",
          border: "1px solid #E5E5E5",
          boxShadow: open ? "0 6px 16px rgba(0,0,0,0.16)" : "0 4px 12px rgba(0,0,0,0.12)",
        }}
      >
        {allDone ? (
          <div
