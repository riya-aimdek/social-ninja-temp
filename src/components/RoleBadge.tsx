...
interface RoleBadgeProps {
  role: 'super-admin' | 'agency-admin' | 'agency-account-manager' | 'client-admin' | 'content-creator' | 'approver' | 'social-media-manager' | 'guest' | 'agency' | 'organization' | 'client' | 'user' | 'engagement' | 'analyst';
  className?: string;
}
...
const roleConfig: Record<string, { label: string; color: string; bg: string }> = {
  ...
  'client-admin': { label: 'Client Admin', color: 'text-client', bg: 'bg-client/15' },
  ...
  'organization': { label: 'Client', color: 'text-client', bg: 'bg-client/15' },
  'client': { label: 'Client', color: 'text-client', bg: 'bg-client/15' },
